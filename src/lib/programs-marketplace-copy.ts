...
const c: Record<Locale, ProgramsMarketplaceCopy> = {
  en: {
    ...
    cinematicSub:
      "51 complete 12-week systems. Home or gym. Fat loss, muscle gain, performance, recovery.",
    filterLabel: "Filters",
    filterGoal: "Goal",
  ...
  tr: {
    ...
    cinematicSub:
      "51 adet 12 haftalik sistem. Ev veya salon. Yag yakimi, kas gelisimi, performans, toparlanma.",
  ...
  ar: {
    ...
    cinematicSub: "٥١ نظاماً كاملاً لمدة ١٢ أسبوعاً. منزل أو صالة. حرق دهون، بناء عضلات، أداء، استشفاء.",
  ...
  es: {
    ...
    cinematicSub: "51 sistemas completos de 12 semanas. Casa o gimnasio. Perder grasa, ganar musculo, rendimiento, recuperacion.",
    filterLabel: "Filtros",
    filterGoal: "Objetivo",
  ...
  fr: {
    ...
    cinematicSub:
      "51 systemes complets sur 12 semaines. Maison ou salle. Perte de graisse, prise de muscle, performance, recuperation.",
    filterLabel: "Filtres",
    filterGoal: "Objectif",
    filterLocation: "Lieu",
    filterLevel: "Niveau",
