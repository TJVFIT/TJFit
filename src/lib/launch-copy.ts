...
const communityCopy: Record<Locale, CommunityCopy> = {
  en: {
    ...
    tabs: { challenges: "Challenges", transformations: "Transformations", blogs: "Blogs", people: "People", groups: "Groups" },
  ...
  tr: {
    ...
    tabs: { challenges: "Meydan okumalar", transformations: "Dönüşümler", blogs: "Blog", people: "Kişiler", groups: "Gruplar" },
    ...
    blogLoadFailed: "Bloglar yüklenemedi.",
    publishFailed: "Blog yayınlanamadı.",
    publishSuccess: "Blog yazısı yayınlandı.",
    deleteFailed: "Blog silinemedi.",
    deleteSuccess: "Blog silindi.",
    pinFailed: "Sabitlenemedi.",
    pinSuccess: "Blog sabitlendi.",
    unpinSuccess: "Blog sabitten kaldırıldı.",
  ...
  ar: {
    ...
    tabs: { challenges: "التحديات", transformations: "التحولات", blogs: "المدونات", people: "الأشخاص", groups: "المجموعات" },
  ...
  es: {
    ...
    tabs: { challenges: "Retos", transformations: "Transformaciones", blogs: "Blogs", people: "Personas", groups: "Grupos" },
  ...
  fr: {
    ...
    tabs: { challenges: "Defis", transformations: "Transformations", blogs: "Blogs", people: "Personnes", groups: "Groupes" },
...
const footerCopy: Record<Locale, FooterCopy> = {
  ...
  tr: {
    description: "Daha akıllı antrenman. Daha iyi beslenme. Daha hızlı dönüşüm.",
    tagline: "Daha akıllı antrenman. Daha iyi beslenme. Daha hızlı dönüşüm.",
    productTitle: "Ürün",
    companyTitle: "Şirket",
    supportTitle: "Destek",
...
const navMenuSummaries: Record<Locale, NavMenuSummaries> = {
  ...
  tr: {
    ...
    transformations: "Başarı hikâyeleri",
    ai: "Akıllı rehber",
    membership: "Üyelik",
    support: "Yardım",
    live: "Canlı",
...
const adminCoachCopy: Record<Locale, AdminCoachCopy> = {
  ...
  tr: {
    ...
    subtitle: "Bir koç hesabı oluşturmak için e-posta ve şifre gir. Giriş yapıp koç paneline erişebilirler.",
