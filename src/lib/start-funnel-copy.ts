...
const c: Record<Locale, StartFunnelCopy> = {
  ...
  tr: {
    landingHeadline: "Doğru programı bul. Ücretsiz başla.",
    landingSubheadline: "Üç hızlı soru — kişisel başlangıç planın. Kart gerekmez.",
    ctaFindPlan: "Planımı Bul",
    quizProgress: "Adım {current} / {total}",
    question1Title: "Ana hedefin ne?",
    question2Title: "Nerede antrenman yapacaksın?",
    ...
    locGym: "Salonda",
    dietCut: "Kesim",
    dietCutHint: "Yağ azalt",
    dietBulk: "Bulk",
    dietBulkHint: "Kas inşa",
    stepLocationNote: "En yakın ücretsiz TJFit başlangıcına yönlendiriyoruz; kütüphaneden değiştirebilirsin.",
    next: "Devam",
    back: "Geri",
    resultTitle: "Ücretsiz başlangıç planın",
    resultSubtitle: "Cevaplarına göre bu ikisiyle başla — tam erişim ücretsiz hesapla.",
    resultProgramLabel: "Antrenman programı",
    resultDietLabel: "Beslenme başlangıcı",
    ctaStartFree: "Şimdi Başla — Ücretsiz",
    ctaBrowsePrograms: "Tüm programlar",
    ctaBrowseDiets: "Tüm diyetler",
    retakeQuiz: "Baştan başla",
    resultNoteFatGym:
      "Ücretsiz yağ yakımı başlangıcımız ev odaklı — salondayken ufak uyarlamalarla kullanabilir veya tam salon kesimi için yükseltebilirsin.",
    resultNoteMuscleHome:
      "Ücretsiz kas başlangıcımız salon ağırlıkları için — ev seçenekleri için kütüphaneye göz at."
  },
  ar: {
