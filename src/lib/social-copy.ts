...
const socialCopy: Record<Locale, SocialCopy> = {
  en: {
    ...
    loginRequiredTitle: "Sign in to unlock this",
    loginRequiredBody: "Search members, open profiles, and message — once you’re signed in.",
  ...
  tr: {
    ...
    peopleSearchSubtitle:
      "Kullanıcı adı veya görünen ada göre ara. Sonuçlar gizlilik kurallarına uyar.",
    searchPlaceholder: "Kullanıcı adı veya isim…",
    searchHint: "En az 2 karakter girin.",
    searchPrivacyNote:
      "Aramayı açan üyeler görünür. Gizli hesapların özeti burada gösterilmez; mesajlaşma ayarları uygulanır.",
    ...
    messagingBlocked: "Ayarlarına göre mesajlaşma açık değil.",
    cannotMessageSelf: "Kendinizle sohbet başlatamazsınız.",
    roleCoach: "Koç",
    roleAdmin: "Yönetici",
    roleUser: "Üye",
    backToSearch: "Aramaya dön",
    messageSettingsTitle: "Profil ve mesajlaşma",
    messageSettingsSubtitle: "Kullanıcı adı, görünürlük ve kimler yazabilir.",
    usernameLabel: "Kullanıcı adı",
    usernameHint: "3–20 karakter: harf, rakam, alt çizgi, nokta.",
    displayNameLabel: "Görünen ad",
    avatarUrlLabel: "Avatar URL",
    bioLabel: "Biyografi",
    accountVisibilityLabel: "Hesap görünürlüğü",
    visibilityPublic: "Herkese açık",
    visibilityPrivate: "Gizli — başkaları sınırlı görür",
    searchableLabel: "Kullanıcı aramasında görün",
    searchableHelp: "Kapalıysa arama sonuçlarında çıkmazsınız.",
    messagePrivacyLabel: "Kimler mesaj atabilir",
    privacyEveryone: "Herkes",
    privacyNobody: "Kimse",
    privacyStaff: "Sadece koç ve yönetici",
    privacyConnections: "Sadece koç bağlantılarım",
    ...
    newChatButton: "Sohbet başlat",
    coachChatShortcut: "Koçunuz",
    openCoachChat: "Aç",
    conversationCoach: "Koç",
    conversationDirect: "Direkt",
    threadBack: "Gelen kutusu",
    settingsLink: "Mesaj ayarları",
    profileEditPageTitle: "Profili düzenle",
    memberSinceLabel: "Üyelik tarihi",
    lastUpdatedLabel: "Son güncelleme",
    loginRequiredTitle: "Bunun için giriş yap",
    loginRequiredBody: "Üye ara, profil aç, mesaj at — girişten sonra hepsi açılır.",
    viewProfileButton: "Profili gör",
    signInToMessage: "Mesaj için giriş yap",
    retryLabel: "Tekrar dene",
    usernameInvalidClient: "3–20 karakter: sadece harf, rakam, alt çizgi veya nokta.",
    profileChooseUsernameHint:
      "Herkese açık profil bağlantısı için bir kullanıcı adı seçin.",
