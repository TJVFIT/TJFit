...
export const STORE_COPY: Record<Locale, StoreCopy> = {
  en: {
    ...
    description: "Build your training space, from a few home essentials to a complete residential gym. Explore our equipment and accessory catalogue, with availability confirmed before you buy.",
  ...
  tr: {
    ...
    description: "Evdeki temel ekipmanlardan eksiksiz bir site spor salonuna, antrenman alanınızı oluşturun. Ekipman ve aksesuar seçkimizi keşfedin; satın almadan önce stok ve teslimat teyit edilir.",
  ...
  ar: {
    ...
    description: "جهّز مساحة تدريبك، من أساسيات المنزل إلى صالة سكنية متكاملة. استعرض المعدات والإكسسوارات، مع تأكيد التوفر والتسليم قبل الشراء.",
  ...
  es: {
    ...
    description: "Crea tu espacio de entrenamiento, desde accesorios para casa hasta un gimnasio residencial completo. Explora el catálogo; disponibilidad y entrega se confirman antes de comprar.",
  ...
  fr: {
    ...
    description: "Créez votre espace d’entraînement, des essentiels à domicile à une salle résidentielle complète. Découvrez notre catalogue ; disponibilité et livraison sont confirmées avant l’achat.",
