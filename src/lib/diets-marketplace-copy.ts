...
const copy: Record<Locale, DietsMarketplaceCopy> = {
  ...
  tr: {
    cinematicEyebrow: "BESLENME SİSTEMLERİ",
    cinematicHeadlineBefore: "Size uygun ",
    cinematicHeadlineGradient: "diyeti bulun.",
    cinematicSub: "10 tam diyet sistemi. Kesim veya bulk. Günlük öğünler, makrolar ve tarifler.",
    ...
    emptyFilterSub: "Filtreleri değiştirin veya tüm diyetlere bakın.",
    footerCta: "Emin değil misiniz? Ücretsiz diyetle başlayın →",
    eyebrow: "Beslenme",
    title: "Kesim, kontrollü kas ve düzen için yapılandırılmış öğün sistemleri.",
    body: "Kesim veya bulk ile filtrele. Ücretsiz başlangıçlar giriş sonrası açılır; 12 haftalık sistemler tam protokol ve yükseltme yolu sunar.",
    typeTagCutting: "Kesim",
    typeTagBulking: "Bulk",
    macroFocused: "Makro odaklı plan",
    browseProgramsLink: "Antrenman programlarına git",
    formatTargetKcal: (kcal) => `~${kcal} kcal / gün`,
    formatRangeKcal: (min, max) => `~${min}–${max} kcal / gün`
  },
  ar: {
