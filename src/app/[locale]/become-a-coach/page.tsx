    ...
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <a
            href="#apply"
            className="mt-8 inline-flex min-h-[52px] items-center justify-center gooey-cta rounded-full bg-[linear-gradient(135deg,#A855F7,#7C3AED)] shadow-[0_0_16px_rgba(168,85,247,0.2)] hover:shadow-[0_0_24px_rgba(168,85,247,0.32)] transition-[transform,box-shadow] duration-200 hover:scale-[1.02] px-8 py-3 text-base font-bold text-background transition hover:bg-white"
          >
