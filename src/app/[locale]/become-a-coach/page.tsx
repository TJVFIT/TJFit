    ...
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <a
            href="#apply"
            className="mt-8 inline-flex min-h-[52px] items-center justify-center rounded-full bg-accent px-8 py-3 text-base font-bold text-background transition hover:bg-white"
          >
            {c.applyNow}
          </a>
        </div>
