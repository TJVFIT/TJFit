    ...
    <ProtectedRoute locale={locale} requireAdmin>
      ...
      <div className="glass-panel rounded-[36px] p-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          <div className="rounded-[28px] border border-dashed border-cyan-300/20 bg-[linear-gradient(180deg,rgba(34,211,238,0.04),rgba(0,0,0,0.3))] p-8 text-center text-xs uppercase tracking-[0.24em] text-cyan-200/70 shadow-[inset_0_0_28px_-12px_rgba(34,211,238,0.2)]">
            Before photo
          </div>
