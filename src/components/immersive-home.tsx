...
export function ImmersiveHome({
  ...
  const features = [
    ...
    { icon: Globe, title: "5 Languages", desc: "Training and nutrition flows are localized in five fully translated locales from the first visit.", accent: "#94A3B8", span: 1 as const }
  ] as const;
