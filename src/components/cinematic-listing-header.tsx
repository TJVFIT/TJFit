    ...
    >
      ...
      <div className="relative z-[1] mx-auto w-full min-w-0 max-w-[1200px]">
        ...
        >
          ...
          <span className="bg-gradient-to-r from-[#EDE9FE] via-[#A855F7] to-[#7C3AED] bg-clip-text bg-[length:200%_100%] text-transparent motion-safe:animate-[tj-title-shimmer_9s_linear_infinite]">
