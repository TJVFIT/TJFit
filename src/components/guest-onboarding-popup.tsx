      ...
      <div className="glass-panel w-full max-w-lg rounded-[28px] p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <button
            ...
            className="rounded-full border border-white/15 px-5 py-2.5 text-sm text-white transition-[border-color,background-color,color,box-shadow] duration-200 hover:border-purple-300/40 hover:bg-purple-300/[0.05] hover:text-purple-50 hover:shadow-[0_0_16px_rgba(168, 85, 247,0.14)]"
          >
            {copy.viewWebsite}
          </button>
        </div>
