...
> = {
  ...
  tr: {
    title: "Ücretsiz 3 Günlük Antrenman Planı Al",
    sub: "Haftalık fitness ipuçları ve beslenme rehberleri de gelir. Spam yok.",
    placeholder: "örnek@mail.com",
    cta: "Planı Gönder",
    success: "Gelen kutunu kontrol et — ücretsiz planın yolda.",
    duplicate: "Bu e-posta zaten kayıtlı.",
    invalid: "Geçerli bir e-posta girin.",
    generic: "Şu an kayıt olunamadı. Tekrar deneyin.",
  },
  ar: {
