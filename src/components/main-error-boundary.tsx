      ...
      fallback={
        <div className="flex min-h-[50vh] flex-col items-center justify-center bg-[#0A0A0B] px-6 py-20 text-center">
          ...
          <button
            ...
            className="mt-8 rounded-full border border-white/[0.12] bg-white/[0.06] px-6 py-2.5 text-sm font-medium text-zinc-100 transition hover:border-cyan-400/35 hover:bg-white/[0.1]"
          >
            Reload page
          </button>
        </div>
