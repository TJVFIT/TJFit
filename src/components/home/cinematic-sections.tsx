...
export function CinematicHowItWorks() {
  return (
    <section className="reveal-section relative overflow-hidden border-t border-[rgba(255,255,255,0.06)] bg-[#09090B] px-6 py-[clamp(3.5rem,8vw,7.5rem)] lg:px-12">
      <span className="ghost-text pointer-events-none start-4 top-16 max-md:opacity-[0.015] md:start-8" aria-hidden>
        PROCESS
      </span>
      <div className="relative z-[1] mx-auto max-w-6xl">
        <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-[#22D3EE]">How it works</p>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3 md:gap-5">
          {steps.map((s) => (
            <div key={s.n} className="relative flex flex-col">
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-[rgba(34,211,238,0.2)] bg-[rgba(34,211,238,0.08)] text-[13px] font-bold text-[#22D3EE]">
                  {s.n}
                </div>
                <div className="mt-4 flex h-10 w-10 items-center justify-center rounded-full border border-[rgba(255,255,255,0.08)] bg-[rgba(34,211,238,0.06)]">
                  <s.Icon className="h-5 w-5 text-[#22D3EE]" strokeWidth={1.5} />
                </div>
...
export function CinematicTransformation({ reduce }: { reduce: boolean }) {
  return (
    <section className="reveal-section relative border-t border-[rgba(255,255,255,0.06)] bg-[#09090B] px-6 py-[clamp(3.5rem,8vw,7.5rem)] lg:px-12">
      <div className="relative z-[1] mx-auto max-w-3xl">
        <div className="glass-panel-glow relative grid overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.06)] md:grid-cols-[1fr_auto_1fr]">
          <div className="relative border-e border-[rgba(255,255,255,0.04)] bg-gradient-to-br from-[rgba(239,68,68,0.06)] to-transparent p-8 md:border-e-0 md:border-s-2 md:border-s-[rgba(239,68,68,0.25)]">
            ...
            <p className="mt-4 text-sm leading-relaxed text-[#A1A1AA]">Baseline load, habit wiring, and honest volume — no hero weeks.</p>
          ...
          <div className="flex flex-col items-center justify-center gap-2 border-y border-[rgba(34,211,238,0.15)] bg-[#0D0F12] px-4 py-6 md:border-x md:border-y-0">
            ...
            <span className="rounded-full border border-[rgba(34,211,238,0.25)] bg-[rgba(34,211,238,0.08)] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#22D3EE]">
              12 weeks
            </span>
            <div className="h-16 w-px bg-gradient-to-b from-transparent via-[rgba(34,211,238,0.35)] to-transparent" />
          </div>
          ...
          <div className="relative border-s border-[rgba(255,255,255,0.04)] bg-gradient-to-bl from-[rgba(34,211,238,0.07)] to-transparent p-8 md:border-s-0 md:border-e-2 md:border-e-[rgba(34,211,238,0.25)]">
            <span className="rounded-full border border-[rgba(34,211,238,0.3)] bg-[rgba(34,211,238,0.1)] px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#22D3EE]">
              Week 12
            </span>
            <p className="mt-4 text-sm leading-relaxed text-[#A1A1AA]">Progressive overload you can feel — strength, composition, and consistency compound.</p>
            <svg
              className={cn("mt-8 h-28 w-full text-[#22D3EE]/25", !reduce && "drop-shadow-[0_0_24px_rgba(34,211,238,0.12)]")}
              viewBox="0 0 120 100"
