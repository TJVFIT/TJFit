...
export function DirectMessageLaunchButton({
  ...
  const baseOutline =
    "rounded-full border border-white/15 px-4 py-2 text-center text-xs font-semibold text-bright transition hover:border-purple-400/35 hover:bg-white/[0.06] disabled:opacity-40 sm:min-w-[7rem]";
  const baseGradient =
