...
> = {
  en: {
    ...
    tjai: "Try TJAI Free",
    tjaiSub: "Answer 25 questions. Get your full AI-powered plan.",
  ...
  tr: {
    ...
    tjaiSub: "25 soruyu cevapla. Tam AI planini al.",
  ...
  ar: {
    ...
    tjaiSub: "أجب على 25 سؤالاً واحصل على خطتك الكاملة.",
  ...
  es: {
    ...
    tjaiSub: "Responde 25 preguntas y recibe tu plan completo.",
  ...
  fr: {
    ...
    tjaiSub: "Repondez a 25 questions et obtenez votre plan IA complet.",
