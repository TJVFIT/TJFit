...
import { Cable, Hand, Link as Chain, RectangleHorizontal, Layers, Circle, CircleDot } from "lucide-react";
import type { Locale } from "@/lib/i18n";
import { ACCESSORY_COPY, ACCESSORY_IDS, buildAccessoryRequest, type AccessorySelection } from "@/lib/store/accessories";
import { SUPPLIER_PENDING, TURKEY_DELIVERY } from "@/lib/store/accessory-details";
...
export function AccessoryCollection({ locale }: { locale: Locale }) {
  ...
  const icons = { "speed-rope": Cable, "training-gloves": Hand, "ankle-bands": Chain, "yoga-block": Layers, "tpe-mat": RectangleHorizontal, "nbr-mat": RectangleHorizontal, "mini-loops": Circle, "ab-wheel": CircleDot };
  return <section id="accessories" aria-labelledby="accessory-title" className="mx-auto max-w-[1400px] scroll-mt-20 px-5 py-14 sm:px-8 lg:px-12">
    ...
    <p className="mt-3 text-xs text-violet-300">{SUPPLIER_PENDING[locale]} · Türkiye</p>
