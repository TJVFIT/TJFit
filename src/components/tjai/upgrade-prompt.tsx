        ...
        <div className="relative">
          ...
          <div className="mt-6 flex gap-2">
            ...
            <button
              type="button"
              onClick={() => setPayload(null)}
              className="rounded-md border border-white/15 px-4 py-2.5 text-sm text-white/70 transition-[border-color,background-color,color,box-shadow] duration-200 hover:border-cyan-300/40 hover:bg-cyan-300/[0.05] hover:text-cyan-100 hover:shadow-[0_0_14px_rgba(34,211,238,0.12)]"
            >
              Later
            </button>
          </div>
