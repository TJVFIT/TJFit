...
const COPY = {
  ...
  tr: {
    loading: "Planım yükleniyor...",
    buildTitle: "12 Haftalık Planını Oluştur",
    buildSub: "Daha akıllı uyarlanabilir değerlendirmeyi tamamla; tam plan için ödeme yap.",
    start: "Oluşturmaya Başla",
    oneTime: `Veya sadece planını al — tek seferlik ($${TJAI_ONE_TIME_PRICE_USD})`,
    note: "~5 dakika · Tamamen kişisel · Bilim temelli",
    dailyCalories: "Günlük kalori",
    proteinTarget: "Protein hedefi",
    trainingDays: "Antrenman günü/hafta",
    goal: "Hedef",
    workout: "Antrenman",
    nutrition: "Beslenme",
    dailyTotals: "Günlük toplamlar",
    downloadPdf: "PDF olarak indir",
    regenerate: "Planı yenile",
    days: "gün",
