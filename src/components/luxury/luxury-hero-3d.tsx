...
function Hero3DBackdropSkeleton() {
  return (
    <div className="pointer-events-none absolute inset-0 z-[1] bg-background" aria-hidden>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(34,211,238,0.09),transparent),radial-gradient(ellipse_50%_40%_at_100%_0%,rgba(14, 165, 233,0.06),transparent)]" />
      <div className="absolute inset-0 animate-pulse bg-gradient-to-br from-cyan-500/[0.07] via-transparent to-sky-500/[0.07]" />
    </div>
  );
}
...
function Hero3DBackdropFallback() {
  return (
    <div className="pointer-events-none absolute inset-0 z-[1]" aria-hidden>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(34,211,238,0.07),transparent),radial-gradient(ellipse_50%_40%_at_100%_0%,rgba(14, 165, 233,0.04),transparent)]" />
    </div>
  );
}
