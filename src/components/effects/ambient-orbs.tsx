    ...
    >
      <div
        ...
        style={{
          ...
          height: `${a.h}px`,
          borderRadius: "50%",
          background: `radial-gradient(circle, rgba(34,211,238,${a.alphaA}) 0%, rgba(34,211,238,${a.alphaB}) 40%, transparent 70%)`,
      ...
      <div
        ...
        style={{
          ...
          height: `${b.h}px`,
          borderRadius: "50%",
          background: `radial-gradient(circle, rgba(14,165,233,${b.alphaA}) 0%, rgba(14,165,233,${b.alphaB}) 45%, transparent 70%)`,
