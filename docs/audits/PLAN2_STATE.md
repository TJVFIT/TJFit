...
| 10 | D | ⓘ Memory dashboard gap audit → docs/audits/tjai-memory-2026-05.md | done | sha-next | Schema has id/user/fact/category/source/created_at + RLS + CASCADE delete. Missing: updated_at, confidence, last_referenced_at. UI doesn't show source or timestamp; no inline edit (backend ready). P1: wire PATCH UI + sensitive consent gate. |
