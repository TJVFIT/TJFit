...
| 13 | E | themeColor → viewport migration | done | sha-next | Already correct in src/app/layout.tsx (themeColor inside `export const viewport`). manifest.ts theme_color is PWA spec, not Next.js. No code change needed — confirmed in commit. |
