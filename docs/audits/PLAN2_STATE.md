...
| 7 | C | Diet registry honesty pass | done | sha7 | APPROVED. diets/index.ts is dead code (imported nowhere, empty weeks) — marked with ⚠ banner. Live diet content = content.ts + bundles.ts. Full content-truth report: docs/audits/content-truth-2026-05.md. |
| 8 | C | Program registry honesty pass | done | sha8 | APPROVED. programs/index.ts registers only comeback12w + imported nowhere — marked with ⚠ banner. content.ts markets 83 programs but 79 have empty blocks (hollow free PDF). P2 reputational. Owner decision A/B/C in content-truth doc. |
