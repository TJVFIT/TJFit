...
|---|---|---|---|---|---|
| 1 | A | Strip TJCOIN from membership-tier/home-sections/email-templates/subscription/i18n copy | done | 2c3cf75 | i18n.ts had no coin refs (false flag from earlier grep) |
| 2 | B | ⓘ Audit medical-safety guards → docs/audits/tjai-safety-2026-05.md | pending | — | — |
