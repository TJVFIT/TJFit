/**
 * Runs all TJFit migrations against the live Supabase DB
 * using JWT auth on the Supabase transaction pooler.
 * 
 * Supabase allows the service role JWT as the DB password on the pooler.
 */
...
// Supabase transaction pooler with JWT auth
const sql = postgres({
